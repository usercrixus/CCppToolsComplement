...
def _append_source_text(source_texts_by_path: dict[str, str], source_path: str, text: str) -> None:
...
def move_header_implementations_to_sources(
    ...
    header_texts_by_path: dict[str, str],
) -> tuple[dict[str, str], dict[str, str]]:
    cleaned_source_texts_by_path = dict(source_texts_by_path)
    cleaned_header_texts_by_path: dict[str, str] = {}
